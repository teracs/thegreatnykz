...
/* $Id: averun.c,v 1.2 2004/06/29 14:59:22 rwzmm Exp $ */
...
int draw_pic()
{
    ...
    time(&now);
    fprintf(fp,
            "[1;37m  0 [36m©¸¡ª¡ª[37m%-12.12sÆ½¾ù¸ºÔØÈËÊýÍ³¼Æ[36m ¡ª¡ª [37m%s[36m ¡ª¡ª©¼[m\n",
            BBSNAME, datestring);
    fprintf(fp,
            "[1;36m      00 01 02 03 04 05 06 07 08 09 10 11 [31m12 13 14");
    fprintf(fp, " 15 16 17 18 19 20 21 22 23[m\n\n");
    fprintf(fp,
            "                         [1;36m    1 [32m¡ö[36m = [37m%3d     [36m Æ½¾ùÉÏÕ¾ÈËÊý£º[37m%3d[m\n",
            item, aver);
    fclose(fp);
}
