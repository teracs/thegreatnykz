...
*/
/*
CVS: $Id: config.h.in,v 1.2 2004/06/29 14:59:21 rwzmm Exp $
*/
...
#define MAXQUERYLINES 15  /* max. # of lines shown by the Query function */
#define MAX_MAIL_HOLD		 (2000)
#define MAX_BMMAIL_HOLD		(3000)
...
#define BBSNAME "水源测试站"
#define BBSID   "SYHBBS"
#define BBSHOST "bbs.siyuanhu.net"
#define BBSIP	"202.120.3.4"
