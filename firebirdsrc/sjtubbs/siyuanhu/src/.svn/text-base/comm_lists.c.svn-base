...
int	t_downline();
int x_cal();
int lunar_syh();//pax@sjtubbs 05-07
int bank_record();//pax@sjtubbs 银行读取记录
int sjtuschedule();//pax@sjtubbs 校历
int research_current_deposit();//pax@sjtubbs 银行活期存款查询
int rate_edit();//银行利率调整
int rpg_pesonailt();//prg pax@bbs
int salary_read();//银行工资调整
int send_salary();//工资发放
int id_detail();//每个id的详细资料
int count_all();//统计全站的资金
int house_agent_input();//房产登记
int house_agent_pay();//房款支付
//int shopping_admin();//商品购买
int festival_money();//全站发钱

//创造空地
int create_Place();
int create_Place_monster();
int create_monster();
int StartMud();
int modify_pker();
...
int tetris(),ent_winmine(),winmine2();
int tt_game();
int gagb();
int x_dice();
int BlackJack(); 
...
//                             {"AddPCorpus", AddPCorpus, 0},
							 ...
							 {"SjtuSchedule",sjtuschedule,0},//pax@sjtubbs 05-07-11 校历
							 {"BankRecord",bank_record,0},//pax@sjtubbs 银行记录读取
							 {"Lunar",lunar_syh,0},//pax@sjtubbs 05 07 15 农历
							// {"Bank",refreshbank,0},
							 {"CurrDepo",research_current_deposit,0},
							 {"Rate",rate_edit,0},//RPG测试
							 {"RPGtest",rpg_pesonailt,0},//
							 {"Salary",salary_read,0},
							 {"SendS",send_salary,0},
							 {"Attack",attack,0},
							 {"CountAll",count_all,0},
							 {"CreArt",create_article,0},
							 {"CreMag",create_magic,0},


							 {"HouseInp",house_agent_input,0},//房产登记
							 {"HousePay",house_agent_pay,0},//房款支付
							 {"Festival",festival_money,0},//全站发钱
							 {"UrgentStart",x_urgent_start,0},//全站发钱
							 {"UrgentStop",x_urgent_stop,0},//全站发钱
							// {"Shop",shopping_admin,0},


{"CreatePlace",create_Place,0},
{"CreatePlaceM",create_Place_monster,0},
{"CreateMonster",create_monster,0},
{"StartMud",StartMud,0},
{"ModifyPker",modify_pker,0},


{"IDDetail",id_detail,0},
{"RelInpu",id_detail_input,0},
{"RelReal",id_detail_release,0},
	...
	{"DownLine",	t_downline,0},
		{"Tetris", 	tetris, 				0},
      {"Winmine2",	winmine2,				0},
		{"XCal" , x_cal,0},
//		/* Add by everlove */
//        {"AuthorSearch","search_all_id",        1},
//        {"TitleSearch", "search_all_title",     1},
//	{"IpFree",      "free_ip",              1},
//	{"QueryMC",     "x_queryuser",          1},
//	{"LogShow",     "show_logrecord",       1},
/*		{"0TTGame",     "tt_game",              1},
        {"Gagb",	"gagb",			1},
        ...
        {"IP_nine",	"p_nine",		1},
        {"OBingo",	"bingo",		1},
        {"Chicken",	"chicken_main",		1},
        {"AdminGame",	"game_manage",		1},
        {"Mary",	"mary_m",		1},
        {"Impawn",	"popshop",		1},
		{"Withdraw",	"withdraw",		1},
        {"Shopping",	"shopping",		1},//modified by smartfish, 2003.09.08.
		{"Lending",	"lending",		1},
	{"StarChicken", "@mod:so/pip.so#mod_default",		1},*/
        ...
        {"IP_nine",	p_nine,0},
        {"OBingo",	bingo,0},
        {"Chicken",	chicken_main,0},
 //       {"AdminGame",	game_manage,0},
        {"Impawn",	popshop,0},
		{"Withdraw",	withdraw,0},
        {"Shopping",	shopping,0},//modified by smartfish, 2003.09.08.
		{"Lending",	lending,0},
//	{"StarChicken", @mod:so/pip.so#mod_default",		1},
#endif 
                             {"Kick", kick_user, 0},
