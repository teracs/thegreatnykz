...
int bbsfddoc_main()
{
    ...
    if ( 0 != start)
        printf("[<a href=bbsfddoc?board=%s&start=%d>ÉÏÒ»Ò³</a>] ", board,
               ((start-20)<0)?0:(start-20));
    if (start+20 < dirsize )
        printf("[<a href=bbsfddoc?board=%s&start=%d>ÏÂÒ»Ò³</a>] ", board,
               start+20);
