...
*/
/*
$Id: bbsgopher.c,v 1.3 2004/07/15 10:18:49 bbs Exp $
*/
...
//    prints
//    ("             .[1;32mF .[37m寄回自己的信箱 .[32m ↑↓.[37m 移动  .[32m→ <Enter>.[37m 读取 .[32m ←.[37m 离开");
//}
//
//printgopher_title ()
//{
...
//                    sprintf (fpath, ".[1m已经帮你转贴到 %s 板了....[m", bname);
//                    prints (fpath);
//                    refresh ();
//                    sleep (1);
//                }
...
//                sprintf (buf,
//                         ".[1;3%dm转.[3%dm换.[3%dm资.[3%dm料.[3%dm中.[m",
//                         (i % 7) + 1, ((i + 1) % 7) + 1, ((i + 2) % 7) + 1,
//                         ((i + 3) % 7) + 1, ((i + 4) % 7) + 1);
//                show_message (buf);
//            }
//            show_message (NULL);
...
//                     print_gophertitle, deal_gopherkey, show_gopher, do_gopher);
//        if (i2 == -1)
//        {
//            free (g_main[gopher_position]);
//            clear_gophertmpfile ();
