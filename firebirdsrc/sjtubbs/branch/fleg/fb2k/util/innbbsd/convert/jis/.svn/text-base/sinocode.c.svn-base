        ...
        if (j != NO_NAMED_CHARACTERS)
        {
            ...
            else
            {
                fprintf(stderr,
                        ...
                        progname,
                        SINOCODE_DEFAULT_MISSING_CHAR, env_vars_to_check[i]);
                fprintf(stderr,
                        "Either they should contain one of the following strings:\n");
...
void find_big(int char1, int char2, int *outchar1, int *outchar2)
{
    int rno, tmp1, tmp2;
...
void find_ibm(int char1, int char2, int *outchar1, int *outchar2)
{
    int rno, tmp1, tmp2;
...
void gb_2312_to_big_5(FILE * infilefp, FILE * outfilefp)
{
    ...
    while ((char1 = getc(infilefp)) != EOF)
    {
        if (char1 >= 160 && char1 <= 255)
        {
            ...
            if (outchar1 == (char) ' ')
            {
                putc(default_missing_char_codes[BIG5_CODE][FIRST],
                     outfilefp);
                putc(default_missing_char_codes[BIG5_CODE][SECOND],
                     outfilefp);
            }
            else
            {
...
void gb_2312_to_ibm_555(FILE * infilefp, FILE * outfilefp)
{
    ...
    while ((char1 = getc(infilefp)) != EOF)
    {
        if (char1 >= 160 && char1 <= 255)
        {
            ...
            if (outchar1 == (int) ' ')
            {
                putc(default_missing_char_codes[IBM555_CODE][FIRST],
                     outfilefp);
                putc(default_missing_char_codes[IBM555_CODE][SECOND],
                     outfilefp);
            }
            else
            {
...
void gb_2312_to_jis_euc(FILE * infilefp, FILE * outfilefp)
{
    ...
    while ((char1 = getc(infilefp)) != EOF)
    {
        if (char1 >= 160 && char1 <= 255)
        {
            ...
            if (outchar1 == (char) ' ')
            {
                putc(default_missing_char_codes[JIS_EUC_CODE][FIRST],
                     outfilefp);
                putc(default_missing_char_codes[JIS_EUC_CODE][SECOND],
                     outfilefp);
            }
            else
            {
...
void big_5_to_gb_2312(FILE * infilefp, FILE * outfilefp)
{
    ...
    while ((char1 = getc(infilefp)) != EOF)
    {
        if (char1 >= 160 && char1 <= 255)
        {
            ...
            if (outchar1 == (char) ' ')
            {
                putc(default_missing_char_codes[GB2312_CODE][FIRST],
                     outfilefp);
                putc(default_missing_char_codes[GB2312_CODE][SECOND],
                     outfilefp);
            }
            else
            {
...
char **argv;
{
    ...
    if (argc == 2)
    {
        ...
        else if (!strcmp(argv[HELPORVERSION], "-help"))
        {
            print_help();
            exit(0);
        }
    ...
    else if (argc == 5)
    {
        ...
        if (!strcmp(argv[INFILENAME], "-"))
            infilefp = stdin;
        else if (!(infilefp = fopen(argv[INFILENAME], "r")))
        {
