...
void show_bm(char firstchar, char *userid)
{
    ...
    else
    {
        ...
        fclose(stream);
        if (f)
            prints("\033[1;32m°å°åÖ÷\033[0;1m]");
    }
}
...
void show_honor()
{
    ...
    while (fgets(line, STRLEN, fp))
    {
        ...
        if (!strcmp(userid, lookupuser.userid))
        {
            ...
            {
            case 'H':
                prints("\033[0mÈÙÓþ:\033[0;1m");
                break;
            case 'T':
                prints("\033[0mÖ°Îñ:\033[0;1m");
                break;
            }
            
            prints(" [\033[1;32m%s\033[0;1m]\033[0m\n", honor);
            fclose(fp);
            return;
        }
    }
...
void show_user_title()
{
    ...
    else if (lookupuser.userlevel & PERM_HASTITLE || lookupuser.userlevel & PERM_HONOR)
    {
        ...
        {
            prints("Ö°Îñ:\033[0;1m");
            
            if (lookupuser.userlevel & (PERM_SPECIAL8 | PERM_OBOARDS))
                prints(" [\033[1;32mÕ¾ÎñÖúÀí\033[0;1m]");
...
int t_query(char *q_id)
{
    ...
    else if (uinfo.mode == QUERY || uinfo.mode == QAUTHOR)
    {
        ...
        move(t_lines - 1, 0);
        sprintf(genbuf, "wikitext/%s", lookupuser.userid);
        if (dashf(genbuf))
            prints
                ("\033[0;1;37;44mÁÄÌì[\033[1;32mt\033[37m] ¼ÄÐÅ[\033[1;32mm\033[37m] ËÍÑ¶Ï¢[\033[1;32ms\033[37m] ¼Ó,¼õÅóÓÑ[\033[1;32mo\033[37m,\033[1;32md\033[37m] Ë®Ô´°Ù¿Æ[\033[1;32mw\033[37m]                           \033[m");
        else
            prints
                ("\033[0;1;37;44mÁÄÌì[\033[1;32mt\033[37m] ¼ÄÐÅ[\033[1;32mm\033[37m] ËÍÑ¶Ï¢[\033[1;32ms\033[37m] ¼Ó,¼õÅóÓÑ[\033[1;32mo\033[37m,\033[1;32md\033[37m]                                       \033[m");
        ch = igetkey();
        ...
        case 'D':
            ...
            {
                sprintf(buf, "%s ±¾À´¾Í²»ÔÚÅóÓÑÃûµ¥ÖÐ", lookupuser.userid);
            }
            else
            {
        ...
        case 'W':
            ...
            {
                move(BBS_PAGESIZE + 2, 32);            
                prints("\033[1m´íÎó£º¸Ã´ÊÌõ²»´æÔÚ\033[m");
                pressanykey();
            }
            break;
        default:
...
int addtooverride(char *uident)
{
    ...
    if (get_num_records(buf, sizeof(struct override)) >= n)
    {
        move(t_lines - 2, 0);
        clrtoeol();
        prints("±§Ç¸£¬±¾Õ¾Ä¿Ç°½ö¿ÉÒÔÉè¶¨ %d ¸ö%s, Çë°´ÈÎºÎ¼þ¼ÌÐø...", n,
               desc);
        igetkey();
        move(t_lines - 2, 0);
        clrtoeol();
