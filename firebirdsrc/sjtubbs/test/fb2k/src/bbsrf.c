...
char *argv[];
{
    ...
    if (uid == BBSUID)
    {
...

        {
            ...
            load = cpu_load[0];
            printf
                ("[1;36mBBS ×î½ü [33m(1,10,15)[36m ·ÖÖÓµÄÆ½¾ù¸ººÉ·Ö±ðÎª[33m %.2f, %.2f, %.2f [36m(Ä¿Ç°ÉÏÏÞ = %d).[0m\n\n",
