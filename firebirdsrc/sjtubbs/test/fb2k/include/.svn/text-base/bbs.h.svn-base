...
#define TRAINER_BOARDNAME	        "BMTraining0"

#define RECOMMEND_DIGEST_BOARDNAME   "Digest"

#define COMMENT_ADMIN_BOARDNAME     "commentadmin"
...
#define FILE_RECOMMENDED    0x8         /*Recommend post , accessed[1]*/
...
#define FILE_NOREPLY2       0x1       /*No Reply By BM, fileheader->accessed[1]*/
