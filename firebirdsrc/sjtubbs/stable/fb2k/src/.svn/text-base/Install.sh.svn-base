...
BBS_HOME=/home/bbstest/bbshome
BBSUID=bbstest
BBSGRP=bbstest
INSTALL="/usr/bin/install -c"
TARGET=/home/bbstest/bbshome/bin
...
boards="bbslists deleted junk message Bulletin sysop syssecurity vote"
...
echo -n "installing movie items (into boards/Bulletin) .. "
mv ${BBS_HOME}/movie.dir ${BBS_HOME}/boards/Bulletin/.DIR
mv ${BBS_HOME}/movie.digest ${BBS_HOME}/boards/Bulletin/.DIGEST
mv ${BBS_HOME}/movie.1 ${BBS_HOME}/boards/Bulletin/M.940902694.A
mv ${BBS_HOME}/movie.1.g ${BBS_HOME}/boards/Bulletin/G.940902694.A
mv ${BBS_HOME}/movie.2 ${BBS_HOME}/boards/Bulletin/M.941325410.A
mv ${BBS_HOME}/movie.2.g ${BBS_HOME}/boards/Bulletin/G.941325410.A
mv ${BBS_HOME}/movie.3 ${BBS_HOME}/boards/Bulletin/M.941325248.A
mv ${BBS_HOME}/movie.3.g ${BBS_HOME}/boards/Bulletin/G.941325248.A
mv ${BBS_HOME}/movie.4 ${BBS_HOME}/boards/Bulletin/M.941655041.A
mv ${BBS_HOME}/movie.4.g ${BBS_HOME}/boards/Bulletin/G.941655041.A
...
PERM_MAILINFINITY   = 0x2000000
PERM_PERSONAL   = 0x4000000
