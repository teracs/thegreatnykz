/* ÆßÌìÎ´ÉÏÕ¾µÄ°åÖ÷Í³¼Æ by soff of bitbbs.org */
...
int main(int argc, char *argv[])
{
    ...
    for (i = 0;; i++)
    {
        ...
        if ((now - aman.lastlogin) / 86400 >= 7)
        {
            ...
            sprintf(buf, "%s/home/%c/%c/%s/.bmfile",
                    BBSHOME,
                    toupper(aman.userid[0]), toupper(aman.userid[1]), aman.userid);
            ...
            for (n = 0; n < 3; n++)
            {
                ...
                fprintf(fout,
                        " ** [1;33m%-16s[m°åÖ÷ [1;32m%-15.15s[m [ %-20.20s ]%6dÌì\n",
    ...
    if (j)
    {
        ...
        fprintf(fout, "\n\n×Ü¹²ÓÐ %d Î»ÆßÌìÎ´ÉÏÕ¾µÄ°åÖ÷¡£\n", j);

        fprintf(fout, "\n[1;31m    ÇëÒÔÉÏ°åÖ÷×¢Òâ¡£[m\n");

        fprintf(fout, "\n\n³¬¹ýÒ»¸öÔÂÁ¬Ðø²»ÉÏÏß½«È¡Ïû°åÖ÷×Ê¸ñ¡£\n", j);
