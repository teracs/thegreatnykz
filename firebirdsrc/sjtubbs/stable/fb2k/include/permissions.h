...
#define PERM_ESYSFILE   (PERM_SYSOP | PERM_WELCOME | PERM_ACBOARD | PERM_ACCOUNTS)
...
#define PERM_HASTITLE   (PERM_OBOARDS | PERM_ACCOUNTS | PERM_OVOTE | PERM_ACHATROOM | \
                        PERM_ACBOARD | PERM_CHATCLOAK | PERM_SPECIAL6 | PERM_ARBITRATOR | \
                        PERM_BOARDS)
...
#define	DEF_BOARDNOTE	 0x20000000
#define	DEF_MORENOCURSOR 0x40000000
