...
/* announce.c */ extern void a_menu (char *maintitle, char *path, char *xpath, int lastlevel, int lastbmonly, int depth);
...
/* bm.c */ extern int board_deny_user(struct fileheader *fileinfo);
...
/* string.c */ extern char *mystrlcpy(char *dest, const char *src, int n);
