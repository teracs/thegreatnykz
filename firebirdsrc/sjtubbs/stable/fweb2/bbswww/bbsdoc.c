...
int bbsdoc_main()
{
    ...
    if (has_blink || has_annorec)
    {
        ...
        {
            printf
                ("<table width='%d' cellspacing='2' cellpadding='1' border='0'>\n", rightside_width);
            printf("<tr bgcolor='e8e8e8'><td>板主推荐</td></tr>\n");
            ...
            if (fp != NULL)
            {
                while (fgets(buf, 255, fp) != NULL)
                {
                    ...
                    printf("<tr><td align='left' bgcolor='#f6f6f6'>");
        ...
        if (has_blink)
        {
            printf
                ("<table width='%d' cellspacing='2' cellpadding='1' border='0'>\n", rightside_width);
            printf("<tr bgcolor='e8e8e8'><td>友情链接</td></tr>\n");
