...
extern struct deny denyuser[512];
extern int denynum;
...
extern int cross_mail(char *userid, char *title, char *file, char *id,
...
extern int fprintf2(FILE * fp, char *s, int *tail, int *sum, int *in_link);
...
extern int cross_article(char *board, char *title, char *file, char *id,
                        char *nickname, char *ip);
extern void post_article2(char *board, char *title, char *file, char *id,
                          unsigned int currid, unsigned int reid);
extern void html_head(void);
extern void html_title_head(char *title);
extern void html_normal(char* source, char* replace);
