...
int bbsreg_main()
{
    ...
    printf
        ("<tr><td align=right>*请输入验证码:<td align=left><input type=text name=vcode maxlength=6>\n");
    printf
        ("<tr><td align=right><input type=\"button\" value=\"看不清\" onclick=\"return refresh()\"><td align=left><img id=vcodeimg src=\"bbsvcode?file=%x\" />\n	<input type=hidden name=vcodefile value=%x /> \n",
         r, r);
    printf
