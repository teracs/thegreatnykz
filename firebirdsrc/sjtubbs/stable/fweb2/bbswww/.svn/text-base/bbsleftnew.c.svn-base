...
#ifdef UPLOAD_SERVER_HEADER
#undef UPLOAD_SERVER_HEADER
#endif
#define UPLOAD_SERVER_HEADER "/file/bbs"
int bbsleftnew_main()
{
    char *ptr;
    char buf[256];
    ...
    if (loginok)
    {
            printf("\n               <img src=" UPLOAD_SERVER_HEADER
                   ...
                   UPLOAD_SERVER_HEADER
                   "/link.gif><a class=left target=f3 href=bbsreply> 查看回复</a><br>\n               %s</div>\n               <img src="
                   UPLOAD_SERVER_HEADER
    ...
    /*printf
        ("<script src=\"https://ssl.google-analytics.com/urchin.js\" type=\"text/javascript\"></script><script type=\"text/javascript\"> _uacct = \"UA-144567-2\"; _usample=13.6;urchinTracker(); </script>");*/
    printf("</body></html>");
