...
int bbsinfo_main()
{
    ...
    printf
        ("<tr><td>您的昵称： <td><input type=text name=nick value='%s' size=24 maxlength=39 id=\"nickName\">\n",
    ...
    printf
        ("<tr><td>真实姓名： <td><input type=text name=realname value='%s' size=16 maxlength=39 id=\"realName\">\n",
         currentuser.realname);
    printf
        ("<tr><td>居住地址： <td><input type=text name=address value='%s' size=50 maxlength=69 id=\"addressStr\">\n",
         currentuser.address);
    ...
    printf
        ("<tr><td>电子邮件： <td><input type=text name=email value='%s' size=32 maxlength=47 id=\"emailStr\">\n",
         currentuser.email);
    printf(
