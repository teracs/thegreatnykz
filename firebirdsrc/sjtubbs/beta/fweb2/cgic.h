...
extern cgiFormResultType cgiFormStringNoNewlines(char *name, char *result,
						 int max);
...
extern cgiFormResultType cgiFormDoubleBounded(char *name, double *result,
					      double min, double max,
					      double defaultV);

extern cgiFormResultType cgiFormSelectSingle(char *name, char **choicesText,
					     int choicesTotal, int *result,
					     int defaultV);


extern cgiFormResultType cgiFormSelectMultiple(char *name, char **choicesText,
					       int choicesTotal, int *result,
					       int *invalid);
...
/* The content type of the uploaded file, as reported by the browser.
	...
	such information. */
extern cgiFormResultType cgiFormFileContentType(char *name, char *result,
						int max);

extern cgiFormResultType cgiFormFileSize(char *name, int *sizeP);

extern cgiFormResultType cgiFormFilePath(char *name, char *buf, int buflen);
