...
extern gboolean ntwww_init(EVENT_ID unload_event, EVENT_ID enter_event, EVENT_ID exit_event);
 ...
 * @see ntw_html_end
 */
extern void ntw_html_str(char *ptr, int len, NTW_IMG_MODE mode, NTW_COLOR_MODE cmode);
