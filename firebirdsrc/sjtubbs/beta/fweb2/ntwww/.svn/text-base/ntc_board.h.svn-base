...
inline static int nt_setboardfile(char *buf, size_t buflen, const char *board, const char *filename)
{
 ...
 */
extern gboolean nt_board_get_tip(char *board, unsigned int boardlen, char *tip, unsigned int tiplen);
