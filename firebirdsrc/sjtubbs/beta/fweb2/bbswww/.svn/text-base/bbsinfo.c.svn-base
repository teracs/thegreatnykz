...
bbsinfo_main()
{
	...
	printf("<center><font class=\"title\">%s - 设置个人资料　　</font>[使用者: %s]<hr>\n", BBSNAME, currentuser.userid);
	//printf("<center><img src=/image/grzl.gif>\n");
	...
	printf("<tr><td>您的昵称： <td><input type=text name=nick value='%s' size=24 maxlength=30>\n", currentuser.username);
	...
	printf("<tr><td>真实姓名： <td><input type=text name=realname value='%s' size=16 maxlength=16>\n", currentuser.realname);
	printf("<tr><td>居住地址： <td><input type=text name=address value='%s' size=40 maxlength=40>\n", currentuser.address);
	...
	printf("<tr><td>电子邮件： <td><input type=text name=email value='%s' size=32 maxlength=32>\n", currentuser.email);
	printf("<tr><td>出生日期： <td><input type=text name=year value=%d size=4 maxlength=4>年", currentuser.birthyear + 1900);
	...
	/*
	   printf("<tr><td>经验值体系：");
	   printf("<td>一般系<input type=radio value=E1 name=exptype %s>, ",
	   currentuser.user_exp_type==0 ? "checked" : "");
	   printf("军衔系<input type=radio value=E2 name=exptype %s>, ",
	   currentuser.user_exp_type==1 ? "checked" : "");
	   printf("百花系<input type=radio value=E3 name=exptype %s>, ",
	   currentuser.user_exp_type==2 ? "checked" : "");
	   printf("隐藏<input type=radio value=E4 name=exptype %s>",
	   currentuser.user_exp_type==3 ? "checked" : "");
	 */
	printf("</table><hr>\n");
