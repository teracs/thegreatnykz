...
bbsform_main()
{
	...
	printf("您好, %s, 请如实详细填写以下各项内容, 经审阅通过后即可获得本站注册用户的各项权限.<br><hr>\n", currentuser.userid);
	printf("<form method=post action=bbsform>\n");
	printf("<input type=hidden name=type value=1>\n");
	printf("*真实姓名: <input name=realname type=text maxlength=8 size=8 value='%s'> (请用中文)<br>\n", nohtml(currentuser.realname));
	printf("*学校系级: <input name=dept type=text maxlength=64 size=32 value='%s'> (在校者请填写学校、系别、年级, 已工作者请填写工作单位)<br>\n", nohtml(currentuser.reginfo));
	printf("*居住地址: <input name=address type=text maxlength=64 size=32 value=''> (请详细填写您的居住地址, 包括寝室或门牌号码)<br>\n");
	printf("*联络电话: <input name=phone type=text maxlength=32 size=32> (最好能填写, 没有可写'无')<br><hr><br>\n");
