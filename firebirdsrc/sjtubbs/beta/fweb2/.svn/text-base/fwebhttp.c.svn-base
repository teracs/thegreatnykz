...
int
set_default_response_code(int num)
{
...
CALLBACK_RETURN reset_http(CALLBACK_ID callback_id, void *data, void *userdata)
{
...
CALLBACK_RETURN fwebhttp_final(CALLBACK_ID callback_id, void *data, void *userdata)
{
