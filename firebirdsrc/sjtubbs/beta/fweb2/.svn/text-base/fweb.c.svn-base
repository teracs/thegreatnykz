...
static void setup_general_event(void)
{
	...
	event_new_request = \
		create_event("new request",EVENT_FLAG_NONE);
	event_finish_request = \
...
init(int argc, char* argv[])
{
	...
	CONFIG config_step1[] = {
		{ group_fweb, "user", CONF_TYPE_STRING, CONF_FLAG_NONE, set_user, NULL},
		{ group_fweb, "working_dir", CONF_TYPE_STRING, CONF_FLAG_REQURIED, set_working_dir, NULL},
	};
	CONFIG config_step2[] = {
		{ group_fweb, "max_cpu_time", CONF_TYPE_INT, CONF_FLAG_REQURIED, set_cpu_time, NULL},
		{ group_fweb, "max_requests", CONF_TYPE_INT, CONF_FLAG_REQURIED, set_max_requests, NULL},
		{ group_fweb, "max_execution_time", CONF_TYPE_INT, CONF_FLAG_REQURIED, set_execution_time, NULL},
	};
	...
	{
		g_warning(\
			"initialize config system failed, used file: %s",\
			config_path);
		return FALSE;
	}
