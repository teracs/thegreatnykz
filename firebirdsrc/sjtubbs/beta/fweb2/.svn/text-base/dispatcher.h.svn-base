 ...
 */
typedef CALLBACK_RETURN (*CALLBACK_F)(CALLBACK_ID callback_id, void *data, void *user_data);
 ...
 * @see remove_callback
 */
extern CALLBACK_ID register_callback(EVENT_ID event_id, CALLBACK_F callback, void *user_data);
