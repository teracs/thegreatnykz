...
static CALLBACK_RETURN mp_final(CALLBACK_ID callback_id, void *data, void *userdata)
{
...
static CALLBACK_RETURN mp_request_init(CALLBACK_ID callback_id, void *data, void *userdata)
{
	__req_mempool.first_ptr = obstack_alloc(&(__req_mempool.obs),sizeof(int));
	__req_mempool.lfirst_ptr = obstack_alloc(&(__req_mempool.large_obs),sizeof(int));
	__req_mempool2.first_ptr = obstack_alloc(&(__req_mempool2.obs),sizeof(int));
	return CALLBACK_CONTINUE;
}

static CALLBACK_RETURN mp_request_final(CALLBACK_ID callback_id, void *data, void *userdata)
{
