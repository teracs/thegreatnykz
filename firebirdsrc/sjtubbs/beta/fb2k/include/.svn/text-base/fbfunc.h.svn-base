...
/* announce.c */ extern void a_menu (char *maintitle, char *path, int lastlevel, int lastbmonly);
...
/* announce.c */ extern int board_in_which_dist (char *boardname);
...
/* bbs.c */ extern int acction_mode (void);
...
/* edit.c */ extern void write_header (FILE *fp, int mode);
...
/* more.c */ extern int readln (int fd, char *buf);
/* more.c */ extern int morekey (void);
...
/* more.c */ extern int rawmore (char *filename, int promptend, int row, int numlines, int stuffmode);
/* more.c */ extern int mesgmore (char *filename, int promptend, int row, int numlines);
/* more.c */ extern int ansimore (char *filename, int promptend);
/* more.c */ extern int ansimore2 (char *filename, int promptend, int row, int numlines);
/* more.c */ extern int ansimore3 (char *filename, int promptend);
...
/* vote.c */ extern void m_OpenJuhuiReg (void);
/* vote.c */ extern void m_CloseJuhuiReg (void);
/* vote.c */ extern void m_DeleteJuhuiReg (void);
/* vote.c */ extern void m_EditJuhuiRegLog (void);
/* vote.c */ extern void m_EditJuhuiRegNote (void);
/* vote.c */ extern void m_RegJuhuiMannually (void);
