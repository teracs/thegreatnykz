...
*/
/*
CVS: $Id: config.sjtu.h,v 1.2 2004/06/29 14:59:21 rwzmm Exp $
*/
/* FIREBIRD BBS 3.0 CONFIGURATION VARIABLES */

#define BBSVERSION      "〔FB2000 v1219〕"

/*
   板主任命时， 如果希望任命文章不仅仅发送到被任命版面，而且同时发送到
   announce 板，或其他版面，你可以打开下面的定义。其中的 announce 可以改成你
   希望发表的版面。注意：这个版面一定要是存在的。
 
*/
#define ORDAINBM_POST_BOARDNAME "announce"

/*D删除的文章被发送到rangedel板面。该功能如果开启，定义值不能为0或1。 added by
 * aegis@011020*/
#define BACK_D_TO_RANGEDEL   99

/*
   允许开启外部程序的用户数目。 比如：BBSNET、WINMINE、SHOWUSER 等
*/

#define MAX_USESHELL    64
...
#define MAXUSERS  65536         /* Maximum number of users,780 aliament 1k */
#define MAXBOARD  1024          /* Maximum number of boards */
#define MAXACTIVE 10001
...
#define MAX_BMMAIL_HOLD		(300)
#define MAX_SYSOPMAIL_HOLD	(500)
...
#define BBSNAME "饮水思源"
#define BBSID   "SJTUBBS"
#define BBSHOST "bbs.sjtu.edu.cn"
#define BBSIP	"202.120.3.1"
