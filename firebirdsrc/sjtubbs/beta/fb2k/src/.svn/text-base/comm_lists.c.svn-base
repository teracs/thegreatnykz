...
int m_ordainBM (void), m_retireBM (void), m_ordainQZ (void), m_retireQZ (void), m_AddTrainingBM(void), m_MinusTrainingBM(void);
#endif
...
//                             {"Personal", Personal, 0},
                             ...
                             {"QueryUser", t_query, 0},
                             {"ShowActive",showStatist,0},//add active use statist by Jerry Zhou.2005/10/23
                             {"Talk", t_talk, 0},
                             {"SetPager", t_pager, 0},
                             {"SetCloak", x_cloak, 0},
                             {"SendMsg", s_msg, 0},
...
//                             {"AddPCorpus", AddPCorpus, 0},
                             ...
                             {"SysFiles", a_edits, 0},
                             {"Wall", wall, 0},
							 //add by clist : admin of juhui regist
							 {"OpenReg", m_OpenJuhuiReg, 0},
							 {"CloseReg", m_CloseJuhuiReg, 0},
							 {"DeleteReg", m_DeleteJuhuiReg, 0},
							 {"EditLog", m_EditJuhuiRegLog, 0},
							 {"EditNote", m_EditJuhuiRegNote, 0},
							 {"ManualReg", m_RegJuhuiMannually, 0},
                             {0, 0, 0}
                         };
...
void
load_sysconf_image (char *imgfile)
{
    struct sysheader
    {
        char *buf;
...
x_denypostqz (void)
{
    ...
    char msgbuf[512], num[2]; //modified by proto@sjtubbs 2006.10.29
