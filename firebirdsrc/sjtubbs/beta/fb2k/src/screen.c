...
*/
/*
$Id: screen.c,v 1.2 2004/06/29 14:59:21 rwzmm Exp $
*/
...
void
outns (register char *str, register int n, register int cc)
{
    if (!cc)
    {
        for (; n > 0; n--)
