...
char Big5bbslinkUsage1[] =
    "セ祘Α璶タ盽磅︽ゲ斗盢郎竚 %s/innd :\n";
char Big5bbslinkUsage2[] =
    "bbsname.bbs   砞﹚禥 BBS ID (叫鲸秖虏祏)\n";
char Big5bbslinkUsage3[] =
    "nodelist.bbs  砞﹚呼隔 BBS  ID, Address ㎝ fullname\n";
char Big5bbslinkUsage4[] =
    "newsfeeds.bbs 砞﹚呼隔獺ン newsgroup board nodelist ...\n";
...
char GBbbslinkUsage1[] =
    "本程式要正常执行必须将以下档案置於 %s/innd 下:\n";
